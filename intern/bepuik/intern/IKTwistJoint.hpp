...
namespace BEPUik
{
	...
	public:
		...
		/// <summary>
		/// Prevents two bones from twisting relative to each other as measured by attaching an axis to each connected bone.
		/// </summary>
		...
		IKTwistJoint(IKBone* connectionA, IKBone* connectionB, Vector3 axisA, Vector3 axisB);
