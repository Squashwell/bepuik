...
namespace BEPUik
{
	...
	public:
		...
		/// Must be unit length.
		/// </summary>
		Vector3 GetLocalLineDirection();
		/// <summary>
		/// Sets the direction of the line in connection A's local space.
		/// Must be unit length.
		/// </summary>
		void SetLocalLineDirection(Vector3 lineDirection);
		...
		IKPointOnLineJoint(IKBone* connectionA, IKBone* connectionB, Vector3 lineAnchor, Vector3 lineDirection, Vector3 anchorB);
