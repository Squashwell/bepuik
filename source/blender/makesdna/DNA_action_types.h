...
typedef enum ePchan_BEPUikFlag {
	BONE_BEPUIK = (1 << 0),
	BONE_BEPUIK_CORE = (1<<1),
	BONE_BEPUIK_AFFECTED_BY_HARD_CONTROL = (1<<2),
	BONE_BEPUIK_ALWAYS_SOLVE = (1<<3),
	BONE_BEPUIK_IS_ACTIVE_BEPUIK_TARGET = (1<<4),
	BONE_BEPUIK_AFFECTED_BY_CONTROL = (1<<5),
...
#define BEPUIK_INTERTIA_TENSOR_SCALING_MIN 2.5f
#define BEPUIK_INTERTIA_TENSOR_SCALING_MAX FLT_MAX
