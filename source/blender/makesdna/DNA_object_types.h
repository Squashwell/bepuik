...
enum {
	OB_BEPUIK = (1<<0),
	OB_BEPUIK_PARENTED_PERIPHERAL_BONES = (1<<1),
	OB_BEPUIK_INACTIVE_TARGETS_FOLLOW = (1<<2),
	OB_BEPUIK_DYNAMIC = (1<<3),
	OB_BEPUIK_MATCH_FINISHED_TRANSFORM = (1<<4)
};
...
#define BEPUIK_DYNAMIC_POSITION_RIGIDITY_DEFAULT 1.0f
#define BEPUIK_DYNAMIC_ORIENTATION_RIGIDITY_DEFAULT 1.0f

#define BEPUIK_DYNAMIC_SOLVE_LENGTH_DEFAULT 20
