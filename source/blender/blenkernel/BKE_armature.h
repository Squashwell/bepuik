...
void BKE_pose_bepuik_visual_transform_apply(struct Object * ob);
void BKE_pose_bepuik_where_is(struct Scene * scene, struct Object * ob, int bepuik_pose_flags);
void BKE_pose_bepuik_feedback(struct Object * ob);
